...
<div id="slide1" className="carousel-item relative w-full">
  ...
  <div className="absolute flex items-center left-0 gap-4 h-full  top-0 bg-gradient-to-r from-[#151515] rounded-2xl to-[rgba(21, 21, 21, 0)]">
    <div className='text-white space-y-7 w-1/2 pl-12'>
      <h2 className='text-6xl font-bold'>Affordable Price For Car Servicing</h2>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam nam doloremque dolores corrupti, libero dolorem!</p>
